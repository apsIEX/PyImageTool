...
class IT_WRAPPER:
    ...
    def __init__(self, info = {}):  
        """
        .intances A dictionary of containing multiple images with several methods to interacting with them

        methods:
            .list => returns key to access the imagetool instance
            .obj => returns the instance
    ...
    def get_properties(self, IT_num):
        '''
